    ...
    return (
      ...
      >
        <div className="row" style={{ height: "100%", textAlign: "left" }}>
          ...
          >
            <h1 style={{ verticalAlign: "middle" }}>About</h1>
            <p>
              I’m a really passionate problem solver. After my barber told me
              about the hassle he goes through to schedule appointments with his
              customers and the lack of suitable solution on the market, I
            ...
            <p>
              ...
              system with surveillance cameras, notifications to contacts and a
              house-wide alarm.
            </p>
            <p>
              I’m heavily into sports and captained my University Ice Hockey
              team. I also ski, play 5-a-side football/soccer and am a major fan
              of Swansea City FC.
            </p>
